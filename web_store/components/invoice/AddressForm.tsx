...
//Optional Address
export default function AddressForm({invoice}: {invoice: Invoice}) {
    ...
    return (
        <Card sx={{ width: '100%' }}>
            <CardContent>
                ...
                <Formik
                    initialValues={{
                        firstName: invoice.address?.firstName || '',
                        lastName: invoice.address?.lastName || '',
                        unit:  '',
                        street: invoice.address?.street || '',
                        city: invoice.address?.city || '',
                        state: invoice.address?.state || '',
                        postcode: invoice.address?.postalCode || ''
                    }}
