        ...
        <>
            <Card
                ...
                <CardContent sx={{ height: 250}}  onClick={() => handleCardClick(review)}>
                    <Box>
                        <Typography variant="body2"  className="text-md" component="div" sx={{
                ...
                <CardActions disableSpacing>
                    <IconButton aria-label="like"
                                className={"hover:bg-[rgba(21,128,61,0.5)] hover:text-green-500 hover:shadow-lg"}
                                onClick={() => {
                    ...
                    >
                        <ThumbUpOffAltOutlined
                            fontSize={"small"}
                            sx={{ color:
                                state === SentimentState.LIKE ? "green" : "inherit"
                        }}/>
                    </IconButton>
                    <IconButton
                    ...
                    >
                        <ThumbDownAltOutlined
                            fontSize={"small"}
                            sx={{
                                color: state === SentimentState.DISLIKE ? "red" : "inherit"
                            }}/>
                    </IconButton>
                </CardActions>
            </Card>
