...
export default function AddressPage({ title, back = { href: ADDRESSES_HREF, label: "Addresses" }, children }: {
    title: string;
    ...
    return (
        ...
        <main className="relative isolate mx-auto flex w-full max-w-6xl flex-col gap-6 px-4 pb-16 pt-8 text-white">
            <FavoriteBackdrop />
            <Link href={back.href} className={`${CHIP} w-fit pl-2 pr-3.5`}>
                <ChevronLeftRoundedIcon sx={CHIP_ICON_SIZE} /> {back.label}
            </Link>
